...
class Login extends Component {
    ...
    processLogin = async () => {
        ...
        try {
            ...
            if (data && data.data.UserLogin.errCode === 0) {
                this.props.userLoginSuccess(data.data.UserLogin);
            ...
            <div className="login-wrapper">
                <div className="login-container">
                    <div className="form_login">
                        ...
                        <div className='errparam' style={{ color: 'red' }}>
                            {loginError}
                        </div>
                    </div>
                </div>
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        userLoginSuccess: (userInfo) => dispatch(actions.userLogin(userInfo))
    };
};
